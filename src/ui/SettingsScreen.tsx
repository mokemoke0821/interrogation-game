  ...
  const difficultyOptions = [
    {
      value: 'EASY',
      label: 'イージー',
      description: '初心者向け - 容疑者が協力的',
    },
    {
      value: 'NORMAL',
      label: 'ノーマル',
      description: 'バランス型 - 標準的な難易度',
    },
    {
      value: 'HARD',
      label: 'ハード',
      description: '上級者向け - 容疑者が頑固',
    },
    {
      value: 'EXTREME',
      label: 'エクストリーム',
      description: '極限 - ほぼ自供しない',
    },
  ];
        ...
        <div className='space-y-6'>
            ...
            <div className='grid grid-cols-4 gap-3'>
              {suspectTypes.map(type => (
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() =>
                    setSettings({ ...settings, suspectType: type.value as any })
                  }
          ...
          <div>
            <h3 className='text-lg font-semibold mb-3'>
              ターン制限:{' '}
              <span className='text-yellow-400'>{settings.turnLimit}</span>
            </h3>
            <input
              type='range'
              min='20'
